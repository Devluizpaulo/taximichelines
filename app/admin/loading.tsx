    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Tabs defaultValue="solicitacoes">
        <TabsList className="mb-6">
          <TabsTrigger value="solicitacoes">Solicitações ({solicitacoes.filter((s) => s.nova).length})</TabsTrigger>
                ...
                filteredSolicitacoes.map((solicitacao) => (
                  <TableRow key={solicitacao.id}>
                    ...
                    <TableCell>
                      ...
                      {solicitacao.nova && <Badge className="ml-2">Nova</Badge>}
                    </TableCell>
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem onClick={() => handleStatusChange(solicitacao.id, "aprovado")}>
                            <CheckCircle className="mr-2 h-4 w-4" />
                            Aprovar
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => handleStatusChange(solicitacao.id, "reprovado")}>
                            <XCircle className="mr-2 h-4 w-4" />
                            Reprovar
                          </DropdownMenuItem>
                          <DropdownMenuSeparator />
                          <DropdownMenuItem onClick={() => handleDeleteSolicitacao(solicitacao.id)}>
              ...
              {filteredContratos.length === 0 ? (
                ...
                filteredContratos.map((contrato) => (
                  <TableRow key={contrato.id}>
                    <TableCell className="font-medium">{contrato.motorista}</TableCell>
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuLabel>Ações</DropdownMenuLabel>
                          <DropdownMenuItem onClick={() => setSelectedClient(contrato)}>
                            <Send className="mr-2 h-4 w-4" />
                            Enviar Mensagem
                          </DropdownMenuItem>
                          <DropdownMenuSeparator />
                          <DropdownMenuItem onClick={() => handleDeleteContrato(contrato.id)}>
                            <Trash2 className="mr-2 h-4 w-4" />
                            Excluir
                          </DropdownMenuItem>
                        </DropdownMenuContent>
        ...
        <Dialog open={!!selectedClient} onOpenChange={() => setSelectedClient(null)}>
          <DialogContent className="max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>Enviar mensagem para {selectedClient.motorista}</DialogDescription>
            </DialogHeader>
            ...
            <DialogFooter>
              ...
              <Button className="bg-blue-600 hover:bg-blue-700 text-white" onClick={() => handleSendMessage("email")}>
